  ...
  module SearchContext
    class ServerItemPaginationComponent < Blacklight::Component
      ...
      def link_to_previous_document(previous_document = nil, classes: 'previous', **link_opts)
        ...
        link_to_unless previous_document.nil?, raw(t('views.pagination.previous')), url_for_document(previous_document, count - 1), link_opts do
      ...
      def link_to_next_document(next_document = nil, classes: 'next', **link_opts)
        ...
        link_to_unless next_document.nil?, raw(t('views.pagination.next')), url_for_document(next_document, count + 1), link_opts do
