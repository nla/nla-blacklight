...
module Blacklight
  ...
  class DocumentPresenter
    ...
    def field_presenters(document_fields = fields, **)
      return to_enum(:field_presenters, document_fields, **) unless block_given?

      fields_to_render(document_fields, **).each { |_, _, config| yield config }
    end
