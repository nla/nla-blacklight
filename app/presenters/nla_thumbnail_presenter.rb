...
class NlaThumbnailPresenter < Blacklight::ThumbnailPresenter
  ...
  def thumbnail_value(image_options)
    image_options = image_options.merge({alt: alt_title_from_document, onerror: "this.style.display='none'", class: thumbnail_image_classes, data: {"scroll-reveal-target": "item", delay: "150ms"}})
