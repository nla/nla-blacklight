...
class NlaThumbnailPresenter < Blacklight::ThumbnailPresenter
  ...
  def thumbnail_value(image_options)
    image_options = image_options.merge({alt: alt_title_from_document, onerror: "this.style.display='none'", class: "w-100 fade border", data: {"scroll-reveal-target": "item", delay: "250ms"}})
