...
class SolrDocument
  ...
  delegate :related_access_urls, :related_terms_urls, :copy_access_urls, :online_access_urls, :has_eresources?, to: :access
  ...
  attribute :cultural_sensitivity_note, :array, "cultural_sensitivity_note_tsim"
