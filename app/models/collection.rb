...
class Collection
  ...
  def get_related_records
    ...
    related_773&.each do |r|
      rec = RelatedRecords.new(@document, collection_id, "773", r)
    ...
    related_973&.each do |r|
      rec = RelatedRecords.new(@document, collection_id, "973", r)
    ...
    if related_773_records.blank? && related_973_records.blank?
      related_records << RelatedRecords.new(@document, collection_id, nil, nil)
    else
