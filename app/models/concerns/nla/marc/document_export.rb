...
module Nla::Marc::DocumentExport
  ...
  def export_as_openurl_ctx_kev(format = nil)
    ...
    if format == "book"
      ...
      export_text << "rft.btitle=#{CGI.escape(title["a"]) unless title.nil? || title["a"].nil?}+#{CGI.escape(title["b"]) unless title.nil? || title["b"].nil?}&amp;"
      export_text << "rft.title=#{CGI.escape(title["a"]) unless title.nil? || title["a"].nil?}+#{CGI.escape(title["b"]) unless title.nil? || title["b"].nil?}&amp;"
      export_text << "rft.au=#{CGI.escape(author["a"]) unless author.nil? || author["a"].nil?}&amp;"
      ...
      export_text << "rft.date=#{CGI.escape(publisher_info["c"]) unless publisher_info.nil? || publisher_info["c"].nil?}&amp;"
      export_text << "rft.place=#{CGI.escape(publisher_info["a"]) unless publisher_info.nil? || publisher_info["a"].nil?}&amp;"
      export_text << "rft.pub=#{CGI.escape(publisher_info["b"]) unless publisher_info.nil? || publisher_info["b"].nil?}&amp;"
      export_text << "rft.edition=#{CGI.escape(edition["a"]) unless edition.nil? || edition["a"].nil?}&amp;"
      export_text << "rft.isbn=#{isbn["a"] unless isbn.nil? || isbn["a"].nil?}"
      ...
      export_text << "rft.title=#{CGI.escape(title["a"]) unless title.nil? || title["a"].nil?}+#{CGI.escape(title["b"]) unless title.nil? || title["b"].nil?}&amp;"
      export_text << "rft.atitle=#{CGI.escape(title["a"]) unless title.nil? || title["a"].nil?}+#{CGI.escape(title["b"]) unless title.nil? || title["b"].nil?}&amp;"
      export_text << "rft.aucorp=#{CGI.escape(corp_author["a"]) if corp_author["a"]}+#{CGI.escape(corp_author["b"]) if corp_author["b"]}&amp;" if corp_author.present?
      export_text << "rft.date=#{CGI.escape(publisher_info["c"]) unless publisher_info.nil? || publisher_info["c"].nil?}&amp;"
      export_text << "rft.issn=#{issn["a"] unless issn.nil? || issn["a"].nil?}"
    else
