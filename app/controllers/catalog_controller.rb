...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field "parent_id_ssi", label: "Collection: Parent", include_in_advanced_search: false, limit: true
    config.add_facet_field "collection_id_ssi", label: "Collection", include_in_advanced_search: false, limit: true
    ...
    config.add_show_field "isbn", label: "ISBN", accessor: :isbn, helper_method: :list
