...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_sort_field "relevance", sort: "score desc, pub_date_ssim desc, title_si asc", label: "Relevance"
    config.add_sort_field "date-desc", sort: "pub_date_ssim desc, title_si asc", label: "Date New to Old"
    config.add_sort_field "date-asc", sort: "pub_date_ssim asc, title_si asc", label: "Date Old to New"
    ...
    config.add_sort_field "title-asc", sort: "title_si asc, pub_date_ssim desc", label: "Title A-Z"
    config.add_sort_field "title-desc", sort: "title_si desc, pub_date_ssim desc", label: "Title Z-A"
