...
module ApplicationHelper
  ...
  def show_search_bar?
    !current_page?(root_path) && !current_page?(advanced_search_catalog_path) && !current_page?(bento_search_index_path) && !current_page?(new_user_session_path)
  end
  ...
  def show_global_message?
    !current_page?(search_catalog_path) || (current_page?(search_catalog_path) && has_search_parameters?)
  end
